...
TIME_ZONE = 'Asia/Kolkata'  # Chennai's timezone
...
SECRET_KEY = 'django-insecure-!v))0isx)!sg-ey(7!r+05-2gfq*^1@by6xpee$!=v2co=3i8!'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'website' / 'static']  # Specify the static folder in your app
